...
import { persist, createJSONStorage } from 'zustand/middleware'; // ⭐️ persist와 createJSONStorage 임포트

const UserStates = create(
  persist(
    (set) => ({ // get은 현재 setUser에서 사용하지 않으므로 제거했습니다. 필요하면 다시 추가하세요.
      ...
      clearAuth: () => {
        set({
          userId: null, email: null, fullName: null, phone: null,
          accessToken: null, refreshToken: null,
        });
        console.log("Zustand persist: 사용자 정보가 초기화되었습니다.");
      }
    }),
  )
);
